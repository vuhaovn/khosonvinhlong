...
function base_url($path = '') {
  ...
  $host = $_SERVER['HTTP_HOST']; // Tên host
  $base = $protocol . $host . '/khosonvinhlong/'; // URL gốc
  return $base . ltrim($path, '/'); // Trả về URL đầy đủ
}
...
<head>
  ...
  <link rel="manifest" href="<?php echo base_url('public/images/favicon/site.webmanifest') ?>">

  <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.css">
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-KK94CHFLLe+nY2dmCWGMq91rCGa5gtU4mk92HdvYe+M/SXH301p5ILy+dN9+nJOZ" crossorigin="anonymous">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url('public/css/vendor.css') ?>">
...
<body>
  ...
  <header>
    <div class="container-fluid">
      <div class="row py-3 border-bottom justify-content-between align-items-center">
        ...
        <div class="col-sm-6 offset-sm-2 offset-md-0 col-lg-4">
          <div class="search-bar row bg-light p-2 rounded-4">
            <form
              id="search-form"
              class="d-flex gap-3"
              action="index.php?controller=home&action=search"
              method="post"
            >
              <input type="text" name="query" class="form-control border-0 bg-transparent" placeholder="Tìm kiếm tên sản phẫm">
